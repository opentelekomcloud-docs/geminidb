:original_name: nosql_dynamodb_0084.html

.. _nosql_dynamodb_0084:

Managing Manual Backups
=======================

To ensure data reliability, GeminiDB DynamoDB-Compatible API allows you to manually back up instances that are in the **Available** state. If a database or table is deleted maliciously or accidentally, backups can help recover your data.

.. note::

   -  By default, you can create up to 50 manual backups.
