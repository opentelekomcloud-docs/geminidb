:original_name: nosql_07_0004.html
...
-  You can export a parameter template of a DB instance for future use. To learn how to apply the exported parameter template to a DB instance, refer to section :ref:`Applying a Parameter Template <nosql_07_0008>`.
